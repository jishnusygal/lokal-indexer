...
4. Set **Public service URL** in Lokal to the address your applications **and download client** can reach, e.g. `http://192.168.1.10:8000`. Inside a shared Docker network this can be `http://lokal-indexer:8000`. `localhost` inside another container points to that container.
